...
@Service("emailForgotPasswordService")
public class EmailForgotPasswordServiceImpl implements EmailService {

    private static final Logger logger = LoggerFactory.getLogger(EmailForgotPasswordServiceImpl.class);
