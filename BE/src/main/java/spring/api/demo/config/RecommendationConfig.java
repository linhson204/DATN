...
public class RecommendationConfig {
     ...
     */
    int maxTotalCandidates = 50;

    /**
     * Số ngày cần xem xét dữ liệu co-view (nguồn cluster).
     */
    int clusterLookbackDays = 30;

    /**
     * Chênh lệch điểm tối đa giữa các nguồn để coi sản phẩm 
     * là tương tự (ví dụ: nếu đặt là 15, thì sản phẩm có điểm 
     * chênh lệch trong khoảng ±15 điểm so với sản phẩm gốc sẽ được 
