...
export function IconProduct() {
  return (
    <svg viewBox="0 0 24 24" fill="currentColor">
      <path d="M20 6h-2.18c.07-.44.18-.88.18-1.35C18 2.08 15.92 0 13.35 0c-1.3 0-2.48.52-3.35 1.36C9.13.52 7.95 0 6.65 0 4.08 0 2 2.08 2 4.65c0 .47.11.91.18 1.35H0v14h24V6h-4zm-5-4.45c1.02 0 1.65.73 1.65 1.65 0 .42-.17.81-.45 1.1-.02.02-.04.03-.06.05l-.04.05H9.9c-.02-.02-.04-.03-.06-.05-.28-.29-.45-.68-.45-1.1 0-.92.63-1.7 1.65-1.7z" />
    </svg>
  );
}
